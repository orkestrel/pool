...
const MODULES = Object.freeze({ '@orkestrel/pool': 'src/core', '@src/core': 'src/core' })
/**
...
// the source — and a name that resolves proves nothing about the sentence beside it, so a
// fence whose comment claims a value the code contradicts passes all of them. The cases
// here run the flagship fence and assert the values its comments claim. Change a fence,
